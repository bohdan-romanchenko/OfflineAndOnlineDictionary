...
namespace Translator
{
    ...
    public static class GetTranslation
    {
        ...
        public static string TranslateTextWithGoogle(string input, string languagePair)
        {
            try
            {
                string url1 = String.Format("http://www.google.com/translate_t?hl=en&ie=UTF8&text={0}&langpair={1}", input, languagePair);
                ...
                string result = webClient.DownloadString(url1);
                //parsing
